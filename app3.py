...
DEVELOPER_KEY = "AIzaSyBqTfGbNEjJGSHNhejG2Wq7dFjS4hyu_9o"
...
def get_results(df_video, threshold=5000):
        ...
        for item in subscriber_list['items']:
                ...
                if len(item['statistics']) > 0:
                        ...
                        subscriber['subscriberCount'] = int(item['statistics']['subscriberCount'])
                else:
                        subscriber['channel_id'] = item['id']                    
        ...
        results = results.loc[:,['video_id', 'title' , 'view_count', 'subscriberCount', 'channel_id']]
        return results
...
threshold = st.sidebar.slider('登録者数の閾値',100, 5000, 10000)
